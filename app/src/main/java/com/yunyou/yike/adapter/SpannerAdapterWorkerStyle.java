 ...
 */
public class SpannerAdapterWorkerStyle extends BaseAdapter {
    private Context context;
    private List<WorkerStyle.DataBean> list;

    public SpannerAdapterWorkerStyle(Context context, List<WorkerStyle.DataBean> list) {
