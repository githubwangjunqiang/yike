...
public class SWViewHolder extends RecyclerView.ViewHolder {
    ...
    public interface AutoUtils {
        void callBackItmeView(View view);
    }

    private AutoUtils mAutoUtils;

    public void setAutoUtils(AutoUtils autoUtils) {
        mAutoUtils = autoUtils;
    }

    public SWViewHolder(View itemView) {
        super(itemView);
        if (mAutoUtils != null) {
            mAutoUtils.callBackItmeView(itemView);
        }
