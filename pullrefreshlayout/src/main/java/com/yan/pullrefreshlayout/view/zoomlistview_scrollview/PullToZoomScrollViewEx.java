package com.yan.pullrefreshlayout.view.zoomlistview_scrollview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    protected class InternalScrollView extends ScrollView {
        ...
        protected void onScrollChanged(int l, int t, int oldl, int oldt) {
            ...
            if (addScrollViewChangedListener != null) {
                addScrollViewChangedListener.onInternalScrollChanged(l, t, oldl, oldt);
            }
        }
    }
    ...
    public interface addScrollViewChangedListener {
        void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop);
    }

    private addScrollViewChangedListener addScrollViewChangedListener;

    public void setaddScrollViewChangedListener(addScrollViewChangedListener addScrollViewChangedListener) {
        this.addScrollViewChangedListener = addScrollViewChangedListener;
    }
}
