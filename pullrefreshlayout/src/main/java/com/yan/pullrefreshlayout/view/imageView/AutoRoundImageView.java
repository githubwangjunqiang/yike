 ...
 */
public class AutoRoundImageView extends android.support.v7.widget.AppCompatImageView {
    /**
     * 图片的类型，圆形or圆角
     */
    private int type;
    ...
    public AutoRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initial(Context context, AttributeSet attrs) {
        ...
        float dimension = array.getDimension(R.styleable.RoundImageView_borderRadius,
                BODER_RADIUS_DEFAULT);
        mBorderRadius = dp2px((int) dimension);
        // 默认为Circle
